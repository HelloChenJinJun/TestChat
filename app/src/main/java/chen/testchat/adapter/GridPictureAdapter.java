 ...
 * QQ:             1981367757
 */
public class GridPictureAdapter extends BaseMultipleWrappedAdapter<ImageItem, BaseWrappedViewHolder> {
        ...
        protected void convert(BaseWrappedViewHolder holder, ImageItem data) {
                ...
                holder.setOnClickListener(R.id.iv_grid_picture_item_display);
        }
