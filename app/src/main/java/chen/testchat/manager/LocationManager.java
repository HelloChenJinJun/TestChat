...
//                                        aMapLocation.getAoiName();//获取当前定位点的AOI信息
                    CustomApplication.getInstance().getSharedPreferencesUtil().putLatLng(latitude + "&" + longitude);
                    CustomApplication.getInstance().getSharedPreferencesUtil().putAddress(address);
                } else {
                    LogUtil.e("定位相同,不定位");
                }
                if (locationList == null) {
                    ...
                    if (aMapLocation.getProvince().equals(aMapLocation.getCity())) {
                        locationList.add(aMapLocation.getProvince() +  aMapLocation.getDistrict() + aMapLocation.getStreet() + aMapLocation.getAoiName());
                        locationList.add(aMapLocation.getProvince() +  aMapLocation.getDistrict() + aMapLocation.getStreet());
                        locationList.add(aMapLocation.getProvince() + aMapLocation.getDistrict());
