...
import chen.testchat.adapter.GroupGridViewAdapter;
...
//                numberAvatar.setOnItemClickListener(this);
        ...
        public void initData() {
                ...
                mAdapter = new GroupGridViewAdapter(null, R.layout.group_info_avatar_item_layout);
                numberAvatar.setLayoutManager(new GridLayoutManager(this, 5));
                numberAvatar.setItemAnimator(new DefaultItemAnimator());
                numberAvatar.addOnItemTouchListener(new OnBaseItemClickListener() {
                        @Override
...
//                                编辑昵称
                        ...
                        case R.id.ll_group_info_remind:
                                isRemind = !isRemind;
                                CustomApplication.getInstance().getSharedPreferencesUtil().setRemind(isRemind, mGroupTableMessage.getGroupId());
                                if (isRemind) {
                                        remind.setText("开启");
                                } else {
                                        remind.setText("关闭");
                        ...
                        switch (requestCode) {
                                case Constant.REQUEST_CODE_TAKE_PICTURE:
                                        ...
                                        bmobFile.uploadblock(CustomApplication.getInstance(), new UploadFileListener() {
                                                ...
                                                public void onSuccess() {
                                                        LogUtil.e("上传群头像成功");
                                                        MsgManager.getInstance().updateGroupMessage(mGroupTableMessage.getGroupId(), "groupAvatar", bmobFile.getFileUrl(CustomApplication.getInstance()), new UpdateListener() {
                                                                @Override
                                                                public void onSuccess() {
                                                                        dismissLoadDialog();
...
//                                                                        MessageCacheManager.getInstance().getGroupTableMessage(mGroupTableMessage.getGroupId()).setGroupAvatar(bmobFile.getFileUrl(CustomApplication.getInstance()));
                                ...
                                case Constant.REQUEST_CODE_SELECT_FROM_LOCAL:
                                        ...
                                        if (cursor != null && cursor.moveToFirst()) {
                                                ...
                                                if (path != null) {
                                                        ...
                                                        bmobFile1.uploadblock(CustomApplication.getInstance(), new UploadFileListener() {
                                                                @Override
                                                                public void onSuccess() {
                                                                        LogUtil.e("上传群头像成功");
                                                                        MsgManager.getInstance().updateGroupMessage(mGroupTableMessage.getGroupId(), "groupAvatar", bmobFile1.getFileUrl(CustomApplication.getInstance()), new UpdateListener() {
                                                                                @Override
                                                                                public void onSuccess() {
                                                                                        dismissLoadDialog();
                                                                                        ToastUtils.showShortToast("更新群头像成功");
                                                                                        LogUtil.e("更新群消息的头像成功");
//                                                                                        LogUtil.e("现在的群头像" + mGroupTableMessage.getGroupAvatar());
//                                                                                        MessageCacheManager.getInstance().getGroupTableMessage(mGroupTableMessage.getGroupId()).setGroupAvatar(bmobFile1.getFileUrl(CustomApplication.getInstance()));
//                                                                                        LogUtil.e("如今的群头像" + mGroupTableMessage.getGroupAvatar());
//                                                                                        ChatDB.create().saveGroupTableMessage(mGroupTableMessage);
