...
//                按升序进行排序
                ...
                query.findObjects(CustomApplication.getInstance(), new FindListener<ChatMessage>() {
                        @Override
...
//                                groupTableQuery.addWhereGreaterThan("updatedAt", new BmobDate(sdf1.parse(lastGroupMessageTime)));
                ...
                groupTableQuery.findObjects(CustomApplication.getInstance(), new FindListener<GroupTableMessage>() {
                                @Override
...
//                                拉取最新的10条说说消息
                ...
                shareQuery.findObjects(CustomApplication.getInstance(), new FindListener<SharedMessage>() {
                        @Override
