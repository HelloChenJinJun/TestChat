...
//                );
//                if (sharedMessage.getVisibleType().equals(ChatConstant.SHARE_MESSAGE_VISIBLE_TYPE_PUBLIC)) {
...
//                        }
//                }
//                if (sharedMessage.getMsgType().equals(ChatConstant.MSG_TYPE_SHARE_MESSAGE_IMAGE)) {
...
//                        }
//                }
//                if (sharedMessage.getMsgType().equals(ChatConstant.MSG_TYPE_SHARE_MESSAGE_VIDEO)) {
//                        if (sharedMessage.getImageList() != null && sharedMessage.getImageList().size() > 0) {
...
//                        }
//                }
//                if (sharedMessage.getMsgType().equals(ChatConstant.MSG_TYPE_SHARE_MESSAGE_LINK)) {
