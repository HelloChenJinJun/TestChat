...
public class TimeUtil {
        ...
        public static String getServerFormatTime() {
                long deltaTime= (long) SPUtils.get(SPUtils.DELTA_TIME,Long.valueOf(0));
//                long deltaTime = BaseApplication.getInstance().getSharedPreferencesUtil().getDeltaTime();
...
//                                 SPUtils.put(SPUtils.DELTA_TIME,Long.valueOf(deltaTime));
//                        }
//
//                        @Override
