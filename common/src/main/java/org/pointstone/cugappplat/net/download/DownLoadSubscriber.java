 ...
 * QQ:             1981367757
 */
class DownLoadSubscriber extends Subscriber<DownInfo> implements OnProgressUpdateListener {
        private SoftReference<DownLoadCallBack<DownInfo>> downLoadCallBack;
        ...
        public void onCompleted() {
                if (downLoadCallBack.get() != null) {
                        downLoadCallBack.get().onCompleted(mDownInfo);
                }
