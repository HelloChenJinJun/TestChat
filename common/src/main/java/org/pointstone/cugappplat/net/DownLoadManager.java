...
public class DownLoadManager {
        ...
        public void download(String videoUrl, String path,String pathName, final OnDownLoadFileListener listener) {
                OkHttpUtils.get().url(videoUrl).build().execute(new FileCallBack(path,pathName) {
                        @Override
...
//        public void downFile(BaseMessage message, final OnDownLoadFileListener onDownLoadFileListener) {
//                LogUtil.e("语音消息的数据格式:");
